class Db4sopensslubAT3X8664 < Formula
  ...
  bottle do
    root_url "https://nightlies.sqlitebrowser.org/homebrew_bottles/homebrew-ub/db4sopensslub@3-x86_64"
    rebuild 1
    sha256 arm64_ventura: "d20406aa63a10d443551f543a98f7df129841cffe9f92357e0cf14bab9aeca53"
  end
  ...
  def install
    ...
    system "lipo", "-create", "-output", "#{lib}/libcrypto.3.dylib", "#{lib}/libcrypto.3.dylib", "/opt/homebrew/opt/db4sopensslub@3-arm64/lib/libcrypto.3.dylib"
    system "lipo", "-create", "-output", "#{lib}/libcrypto.a", "#{lib}/libcrypto.a", "/opt/homebrew/opt/db4sopensslub@3-arm64/lib/libcrypto.a"
    rm "#{lib}/libcrypto.dylib"
    ln_s "#{lib}/libcrypto.3.dylib", "#{lib}/libcrypto.dylib"
  end

  def openssldir
    etc/"db4sopensslub@3-x86_64"
  end
